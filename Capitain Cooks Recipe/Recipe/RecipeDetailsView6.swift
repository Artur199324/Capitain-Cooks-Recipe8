...
struct RecipeDetailsView6: View {
    let dish: Dish
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                HStack(spacing: 16) {
                    NutritionInfoView(value: "14g", nutrient: "protein", icone: "q1")
                    NutritionInfoView(value: "8g", nutrient: "fat", icone: "q2")
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        Text("• 2 slices of German rye bread")
                        Text("• ½ cup (120g) quark or plain Greek yogurt")
                        Text("• 1 tbsp (15ml) olive oil")
                        Text("• 1 tbsp (10g) fresh chives, finely chopped")
                        Text("• 1 tbsp (10g) fresh parsley, finely chopped")
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    1. Prepare the Spread:
                       In a bowl, mix quark, olive oil, chives, parsley, salt, and pepper until smooth.

                    2. Toast the Bread:
                       Lightly toast the rye bread slices in a toaster or under a grill.

                    3. Assemble:
                       Spread the herb quark mixture evenly over each slice of toast. Serve immediately.
                    """)
                    .foregroundColor(.white)
                }
                .padding()
...
#Preview {
    NavigationView {
        RecipeDetailsView6(
            dish: Dish(name: "German Rye Bread Toast with Quark and Herbs", time: "10 min", kcal: "220 kcal", difficulty: "Easy", imageName: "rye_bread_toast"),
