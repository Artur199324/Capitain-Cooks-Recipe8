...
struct RecipeDetailsView50: View {
    let dish: Dish
               ...
               VStack(alignment: .leading, spacing: 16) {
                   ...
                   VStack(alignment: .leading, spacing: 10) {
                       ...
                       VStack(alignment: .leading, spacing: 8) {
                           Text("• 1 cup (120g) graham cracker crumbs")
                           Text("• 1/4 cup (60g) butter")
                           Text("• 1 lb (500g) quark or cream cheese")
                   ...
                   VStack(alignment: .leading, spacing: 8) {
                       ...
                       Text("""
                       1. Make the crust with crumbs and butter. Press into a pan.
                       2. Mix quark, sugar, and eggs. Pour over crust and bake for 60 minutes.
                       """)
                       .foregroundColor(.white)
                   }
                   .padding()
