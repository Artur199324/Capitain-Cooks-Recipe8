...
struct RecipeDetailsView46: View {
    let dish: Dish
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            Text("• 1 packet (32g) vanilla pudding mix")
                            Text("• 2 cups (500g) mixed berries")
                            Text("• 1/4 cup (50g) sugar (for sauce)")
                        }
                        .foregroundColor(.white)
                    }
                    .padding()
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        1. Prepare the Pudding:
                           Prepare vanilla pudding as per package instructions.

                        2. Make the Sauce:
                           Cook berries with sugar for 5 minutes to make the sauce.

                        3. Serve:
                           Serve pudding with berry sauce on top.
                        """)
                        .foregroundColor(.white)
                    }
                    .padding()
