...
struct RecipeDetailsView27: View {
    let dish: Dish
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        1. Prepare the Cabbage Leaves:
                           Bring a pot of water to a boil. Blanch the cabbage leaves for 1–2 minutes until softened. Set aside.

                        2. Prepare the Filling:
                           In a bowl, mix ground beef, chopped onion, cooked rice, egg, paprika, salt, and pepper.

                        3. Stuff the Cabbage Leaves:
                           Place a spoonful of the filling onto each cabbage leaf. Roll up tightly, folding in the sides.

                        4. Cook the Rolls:
                           In a large skillet, melt butter and brown the rolls on all sides. Add beef broth and tomato paste. Simmer covered for 45–60 minutes, occasionally basting with the liquid.

                        5. Serve:
                           Serve the cabbage rolls hot with mashed potatoes or a side salad.
                        """)
                        .foregroundColor(.white)
                    }
                    .padding()
