...
struct RecipeDetailsView14: View {
    let dish: Dish
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    HStack(spacing: 16) {
                        ...
                        NutritionInfoView(value: "16g", nutrient: "fat", icone: "q2")
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            Text("• 4 medium potatoes, boiled and diced")
                            Text("• 2 tbsp (30ml) vegetable oil")
                            Text("• 1 tbsp (15ml) wine vinegar")
                            Text("• 1 small onion, finely chopped")
                            Text("• 1 tbsp (10g) chopped parsley")
                            Text("• 1 tsp (5g) mustard")
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("""
                        1. Prepare the Salad:
                           In a large bowl, mix oil, vinegar, mustard, salt, and pepper to make the dressing.

                        2. Add Ingredients:
                           Add diced potatoes, chopped onion, and parsley. Toss gently to coat.

                        3. Serve:
                           Divide into small glass jars or bowls for easy serving. Garnish with extra parsley.
                        """)
                        .foregroundColor(.white)
                    }
                    .padding()
