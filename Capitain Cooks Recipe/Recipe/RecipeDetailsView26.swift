...
struct RecipeDetailsView26: View {
    let dish: Dish
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            Text("• 2 lbs (1kg) baby potatoes")
                            Text("• 1 small onion, finely chopped")
                            Text("• 3 tbsp (45ml) white vinegar")
                            Text("• 4 tbsp (60ml) vegetable oil")
                            Text("• 1 tsp (15g) Dijon mustard")
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("""
                        1. Boil the Potatoes:
                           Place the potatoes in a pot of salted water. Bring to a boil and cook for 15–20 minutes, or until tender. Drain and let cool slightly.

                        2. Prepare the Dressing:
                           In a bowl, whisk together vinegar, oil, mustard, salt, and pepper.

                        3. Assemble the Salad:
                           Peel the potatoes and slice them while still warm. Toss with the chopped onion and dressing.

                        4. Chill and Serve:
                           Refrigerate for at least 30 minutes. Before serving, garnish with fresh parsley.
                        """)
                        .foregroundColor(.white)
                    }
                    .padding()
