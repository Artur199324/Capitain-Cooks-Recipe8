...
struct RecipeDetailsView41: View {
    let dish: Dish
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            Text("• 4 large potatoes, boiled and cooled")
                            Text("• 1 onion, chopped")
                            Text("• 4 slices of bacon, chopped")
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        2. Fry the Ingredients:
                           In a large pan, fry the bacon until crispy. Add butter and onions, cooking until golden.

                        3. Cook the Potatoes:
                           Add potato slices to the pan and fry until golden and crispy. Season with salt and pepper.
