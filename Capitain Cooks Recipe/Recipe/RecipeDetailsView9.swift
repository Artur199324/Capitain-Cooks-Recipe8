...
struct RecipeDetailsView9: View {
    let dish: Dish
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    HStack(spacing: 16) {
                        ...
                        NutritionInfoView(value: "18g", nutrient: "fat", icone: "q2")
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            Text("• 4 Weisswurst sausages")
                            Text("• 2 large soft pretzels")
                            Text("• 2 tbsp (30g) Bavarian sweet mustard")
                        }
                        .foregroundColor(.white)
                    }
                    .padding()
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("""
                        1. Heat the Sausages:
                           Bring a pot of water to a simmer (not boiling). Add the Weisswurst and heat for 10 minutes.

                        2. Serve:
                           Place the warm sausages on a plate with soft pretzels. Add mustard on the side for dipping.
                        """)
                        .foregroundColor(.white)
                    }
                    .padding()
