...
struct RecipeDetailsView10: View {
    let dish: Dish
        ...
        var body: some View {
            ScrollView {
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    HStack(spacing: 16) {
                        NutritionInfoView(value: "2g", nutrient: "protein", icone: "q1")
                        NutritionInfoView(value: "1g", nutrient: "fat", icone: "q2")
                    ...
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            Text("• 2 apples, diced")
                            Text("• 2 pears, diced")
                            Text("• 1 orange, peeled and segmented")
                            Text("• 1 banana, sliced")
                            Text("• ½ cup (75g) grapes, halved")
                            Text("• 1 tbsp (15ml) lemon juice")
                            Text("• 1 tbsp (15ml) honey or maple syrup")
                            Text("• 1 tbsp (10g) chopped nuts (optional)")
                        }
                        .foregroundColor(.white)
                    }
                    .padding()
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text("""
                        1. Prepare the Fruit:
                           In a large bowl, combine diced apples, pears, orange segments, banana slices, and grapes.

                        2. Add Dressing:
                           Mix lemon juice and honey in a small bowl. Pour over the fruit and toss gently to coat.
