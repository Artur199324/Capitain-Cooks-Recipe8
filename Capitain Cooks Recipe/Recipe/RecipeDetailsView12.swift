...
struct RecipeDetailsView12: View {
    let dish: Dish
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                HStack(spacing: 16) {
                    ...
                    NutritionInfoView(value: "14g", nutrient: "fat", icone: "q2")
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        Text("• 8 small German sausages (Bratwurst or Vienna)")
                        Text("• 1 package (500g) puff pastry")
                        Text("• 1 egg yolk (for brushing)")
                        Text("• 1 tbsp (15ml) milk")
                    }
                    .foregroundColor(.white)
                }
                .padding()
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("""
                    1. Prepare the Dough:
                       Preheat the oven to 400°F (200°C). Roll out the puff pastry and cut it into 8 squares.

                    2. Wrap the Sausage:
                       Place a sausage diagonally on each square of dough. Fold the corners over to wrap the sausage completely.

                    3. Brush and Bake:
                       Mix egg yolk with milk and brush over the rolls. Place on a parchment-lined baking sheet. Bake for 20–25 minutes until golden brown.

                    4. Serve:
                       Allow to cool slightly before serving. Perfect with mustard or ketchup!
                    """)
                    .foregroundColor(.white)
                }
                .padding()
